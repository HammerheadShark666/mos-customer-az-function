...
public class AddCustomerFromRegisteredUserMediatrTests
{
    ...
    [Test]
    public void Customer_not_added_invalid_surname_first_name_return_exception_fail_message()
    {
        customerRepositoryMock
                .Setup(x => x.CustomerExistsAsync("ValidEmail@hotmail.com"))
                .Returns(Task.FromResult(false));
    ...
    [Test]
    public void Customer_not_added_no_email_surname_first_name_return_exception_fail_message()
    {
        customerRepositoryMock
                .Setup(x => x.CustomerExistsAsync("ValidEmail@hotmail.com"))
                .Returns(Task.FromResult(false));
