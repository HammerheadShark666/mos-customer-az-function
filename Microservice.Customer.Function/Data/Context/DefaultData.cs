...
{
    public static List<Microservice.Customer.Function.Domain.Customer> GetCustomerDefaultData()
    {
        return new List<Microservice.Customer.Function.Domain.Customer>()
        {
    ...
    private static Microservice.Customer.Function.Domain.Customer CreateCustomer(Guid id, string surname, string firstName, string email)
    {
        return new Microservice.Customer.Function.Domain.Customer { Id = id, Surname = surname, FirstName = firstName, Email = email };
    }
}